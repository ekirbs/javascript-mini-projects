...
export default function Drumkit() {
  ...
  //     if (e.type === "mousedown" && !keyState[keyCode]) {
  //       keyState[keyCode] = true;
  //       key.classList.add("playing");
  //       audio.currentTime = 0;
  //       audio.play();
  ...
  return (
    <div className="drumkit">
      ...
      <audio
        data-key="66"
        src="./assets/sounds/tunes/babyshark_acoustic.mp3"
      ></audio>
      <audio data-key="77" src="./assets/sounds/tunes/monkeyshark.mp3"></audio>
      <audio
        data-key="49"
        src="./assets/sounds/tunes/happy_countdown.wav"
      ></audio>
      <audio data-key="50" src="./assets/sounds/tunes/fun_gameover.wav"></audio>
      <audio
        data-key="51"
        src="./assets/sounds/tunes/positive_sound.wav"
      ></audio>
    </div>
  );
}
